        ...
        <div class="container mx-auto flex items-start justify-center h-fit py-36 gap-4 flex-wrap">
            ...
            <div class="flex text-xl items-center justify-start flex-row flex-wrap  border-2 border-emerald-950 w-96 px-5 shrink-0  bg-emerald-300 text-emerald-950 rounded-lg py-10">
                ...
                <label for="cardno" class=" my-3 relative flex items-center justify-start h-10 ">
                    <input autocomplete="off" v-model.number="card.no" @keydown="filterInput($event)"  class="px-3 bg-white outline-emerald-950 h-12 pl-32 w-full rounded-lg peer focus:outline-2 leading-10 transition-all placeholder:text-zinc-500 text-zinc-950 focus:text-zinc-500" type="text"  maxlength="16" id="cardno" placeholder="5510 **** **** **** " >
                ...
                <label for="carddate" class=" my-3 relative flex items-center justify-start h-10 ">
                    <input autocomplete="off" v-model.number="card.date" @keydown="filterInput($event)" class="px-3 bg-white outline-emerald-950 h-12 pl-32 w-1/2 md:w-48 rounded-lg peer focus:outline-2 leading-10 transition-all placeholder:text-zinc-500 text-zinc-950 focus:text-zinc-500" type="text" maxlength="4" id="carddate" placeholder="00/55" >
                ...
                <label for="cardcv" class=" my-3 ml-auto relative flex items-center justify-start h-10 ">
                    <input autocomplete="off" v-model.number="card.ccv" @keydown="filterInput($event)"  class="px-3 bg-white outline-emerald-950 h-12 pl-20 w-1/2 md:w-32 rounded-lg peer focus:outline-2 leading-10 transition-all placeholder:text-zinc-500 text-zinc-950 focus:text-zinc-500" type="text" maxlength="3" id="cardcv" placeholder="012">
